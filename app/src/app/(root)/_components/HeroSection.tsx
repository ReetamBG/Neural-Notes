...
const HeroSection = async () => {
  ...
  return (
    <section id="" className="min-h-screen w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      ...
      <div className="max-w-screen mx-auto p-4 relative z-10">
        ...
        <p className="mt-8 text-neutral-400 max-w-lg mx-auto my-2 text-sm md:text-base 2xl:text-xl text-center relative z-10">
          ...
          Interact with your material, uncover weak spots, and get personalized
          roadmaps to master any topic.
        </p>
      ...
      {/* Fades out the content at the bottom */}
      <div className="z-100 absolute bottom-0 left-0 w-full h-40 bg-gradient-to-b from-transparent to-neutral-950 pointer-events-none" />
    </section>
  );
};
